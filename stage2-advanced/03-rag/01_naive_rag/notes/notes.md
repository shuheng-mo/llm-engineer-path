...
RAGAS 是一个基于 RAG 的评测框架，核心思想是用 LLM 来评测 RAG 的效果，属于 LLM as Judge 的范畴。学习如何接入并测试Naive RAG的检索质量可以帮助我们有效改善RAG系统的性能。

## 总结

Naive RAG做为LLM应用爆发初期的技术目前很难再适应生产级的需求，但是依然有宝贵的学习价值，也是做产品原型的时候最常用的简单RAG方案。
